...
def segment_slic_img2d(img, sp_size=50, relative_compact=0.1, slico=False, mask=None):
    ...
    slic_segments = ski_segm.slic(
        img, mask=mask, n_segments=slic_nb_spx, compactness=slic_compact, sigma=1, enforce_connectivity=True, slic_zero=slico
    )
    # slic_segments = cv2.imread('1.png', 0)
